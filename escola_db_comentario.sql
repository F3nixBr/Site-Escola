...
CREATE TABLE `comentario` (
  ...
  CONSTRAINT `comentario_ibfk_1` FOREIGN KEY (`AlunoID`) REFERENCES `aluno` (`AlunoID`),
  CONSTRAINT `comentario_ibfk_2` FOREIGN KEY (`ProfessorID`) REFERENCES `professor` (`ProfessorID`),
  CONSTRAINT `comentario_ibfk_3` FOREIGN KEY (`ResponsavelID`) REFERENCES `responsavel` (`ResponsavelID`)
